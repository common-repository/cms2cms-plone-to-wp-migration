...
class CmsPluginFunctionsPlone
{
    ...
    private $jsConfig = '{
        ...
        "wp_feedback"  : "//wordpress.org/support/plugin/cms2cms-plone-to-wp-migration/reviews",
    ...
    {
        $cms2cms_plone_access_login = get_option('cms2cms-plone-login');
        $cms2cms_plone_access_key   = get_option('cms2cms-plone-key');

        return array(
            'email'     => $cms2cms_plone_access_login,
            'accessKey' => $cms2cms_plone_access_key
        );
    }
    ...
    public function isActivated()
    {
        ...
        return ($cms2cms_plone_access_key != false);
    }
    ...
    public function getOptions()
    {
        ...
        $login = get_option('cms2cms-plone-login');
    ...
    public function saveOptions()
    {
        ...
        if ( $key && $login ) {
            ...
            add_option('cms2cms-plone-key', $key);

            delete_option('cms2cms-plone-login');
            add_option('cms2cms-plone-login', $login);

            delete_option('cms2cms-plone-depth');
            add_option('cms2cms-plone-depth', $bridge_depth);
    ...
    {
        return $this->__('Plone', 'cms2cms-plone-migration');
    }
    ...
    {
        return $this->__('WordPress', 'cms2cms-plone-migration');
    }
    ...
    {
        return sprintf(
            $this->__('CMS2CMS: Automated %s to %s Migration ', 'cms2cms-plone-migration'),
    ...
    {
        return sprintf(
            $this->__('%s to %s', 'cms2cms-plone-migration'),
            $this->getPluginSourceName(),
            $this->getPluginTargetName()
        );
    }
    ...
    public function logOut()
    {
        if (isset($_REQUEST['_wpnonce'])) {
            ...
            if ($this->verifyFormTempKey($nonce, 'cms2cms_plone_logout')
                && $_POST['cms2cms_plone_logout'] == 1
            ) {
                $this->clearOptions();
            }
        }
